...
Nuestro siguiente job consiste en enviar una notificación a los usuarios del proyecto via correo electrónico. Para ello, crearemos nuestra propia Action con JavaScript. Esta tarea tiene la característica de que se ejecutara siempre aun si las demás jobs fallan, ya que indicará los resultados en el mensaje del correo.
